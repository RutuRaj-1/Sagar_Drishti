  ...
  return (
    <div className="student-card student-insights-card">
      <div className="student-card-header">
        <div className="student-card-icon">[AI]</div>
      ...
      <div className="student-disclaimer-box">
        <small>
          Note: AI-generated educational summary based on live model fields & Argo telemetry. Not an official storm or fishing advisory.
        </small>
      </div>
    </div>
  );
